...
interface FormStatusDokumenWajibProps {
  initialData?: FormData; // pass this if editing
  onSuccess?: () => void; // callback after successful submission
}

export function FormStatusDokumenWajib({
  initialData,
  onSuccess,
}: FormStatusDokumenWajibProps) {
  ...
  const mutation = useMutation({
    mutationFn: async (data: FormData) => {
      ...
      const url = data.id
        ? `/api/status-dokumen-wajib/${data.id}`
        : "/api/status-dokumen-wajib";
