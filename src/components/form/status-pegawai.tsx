...
import { StatusPegawaiPicker } from "../status-pegawai-picker";
...
export const formSchema = z4.object({
  ...
  nip: z4.string().min(1, "NIP tidak boleh kosong"),
  golongan: z4.string().min(1, "Golongan tidak boleh kosong"),
  status: z4.string().min(1, "Status tidak boleh kosong"),
  keterangan: z4.string().min(1, "Keterangan tidak boleh kosong"),
});

type FormData = z4.infer<typeof formSchema>;

interface FormStatusPegawaiProps {
  initialData?: FormData; // pass this if editing
  onSuccess?: () => void; // callback after successful submission
}

export function FormStatusPegawai({
  initialData,
  onSuccess,
}: FormStatusPegawaiProps) {
