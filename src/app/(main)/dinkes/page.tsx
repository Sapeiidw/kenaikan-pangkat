...
export default function Page() {
  ...
  const { data: dataKenaikanPangkat } = useQuery({
    ...
    queryFn: async () =>
      await fetch(
        `/api/kenaikan-pangkat?for=dashboard&id_opd=1&year=${year}`
      ).then((res) => res.json()),
  });
  ...
  const { data: dataStatusDokumen } = useQuery({
    ...
    queryFn: async () =>
      await fetch(
        `/api/status-dokumen-wajib?for=dashboard&id_opd=1&year=${year}`
      ).then((res) => res.json()),
  });
  ...
  const { data: dataStatusKenaikanPangkat } = useQuery({
    ...
    queryFn: async () =>
      await fetch(
        `/api/status-kenaikan-pangkat?for=dashboard&id_opd=1&year=${year}&month=${month}`
      ).then((res) => res.json()),
  });
  ...
  const { data: dataStatusSKKenaikanPangkat } = useQuery({
    ...
    queryFn: async () =>
      await fetch(
        `/api/status-sk-kenaikan-pangkat?for=dashboard&id_opd=1&year=${year}&month=${month}`
      ).then((res) => res.json()),
  });
  ...
  const { data: dataGolonganPegawai } = useQuery({
    ...
    queryFn: async () =>
      await fetch(
        `/api/golongan-pegawai?for=dashboard&id_opd=1&year=${year}&month=${month}`
      ).then((res) => res.json()),
  });
  ...
  const { data: dataStatusPegawai } = useQuery({
    ...
    queryFn: async () =>
      await fetch(
        `/api/status-pegawai?for=dashboard&id_opd=1&year=${year}&month=${month}`
      ).then((res) => res.json()),
  });
